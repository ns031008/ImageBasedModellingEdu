...
int main(int argc, char* argv[])
{
    ...
    math::Vector<double, 4> row_0  = (double)p1[0]*(P1.row(2)) - P1.row(0);
    math::Vector<double, 4> row_1  = (double)p1[1]*(P1.row(2)) - P1.row(1);
    math::Vector<double, 4> row_2  = (double)p2[0]*(P2.row(2)) - P2.row(0);
    math::Vector<double, 4> row_3  = (double)p2[1]*(P2.row(2)) - P2.row(1);
    A(0,0)  = row_0[0]; A(0,1) = row_0[1]; A(0,2) = row_0[2]; A(0,3) = row_0[3];
    A(1,0)  = row_1[0]; A(1,1) = row_1[1]; A(1,2) = row_1[2]; A(1,3) = row_1[3];
    A(2,0)  = row_2[0]; A(2,1) = row_2[1]; A(2,2) = row_2[2]; A(2,3) = row_2[3];
    A(3,0)  = row_3[0]; A(3,1) = row_3[1]; A(3,2) = row_3[2]; A(3,3) = row_3[3];
