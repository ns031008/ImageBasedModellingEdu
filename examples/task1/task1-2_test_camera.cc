...
public:
    ...
    math::Vec2d projection(math::Vec3d const &p3d)
    {
        ...
        math::Vec2d p;
        /** TODO HERE */
        math::Vec2d normalization_p, undistord_p;
        double z = (R_[6] * p3d[0] + R_[7] * p3d[1] + R_[8] * p3d[2] + t_[2]);
        normalization_p[0] = (R_[0] * p3d[0] + R_[1] * p3d[1] + R_[2] * p3d[2] + t_[0]) / z;
        normalization_p[1] = (R_[3] * p3d[0] + R_[4] * p3d[1] + R_[5] * p3d[2] + t_[1]) / z;
        double r = normalization_p[0] * normalization_p[0] + normalization_p[1] * normalization_p[1];
        undistord_p[0] = (1 + dist_[0] * r + dist_[1] * pow(r, 2)) * normalization_p[0];
        undistord_p[1] = (1 + dist_[0] * r + dist_[1] * pow(r, 2)) * normalization_p[1];
        p[0] = f_ * undistord_p[0] + c_[0];
        p[1] = f_ * undistord_p[1] + c_[1];
